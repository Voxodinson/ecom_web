...
abstract class StateAPI
{
    ...
    // protected base_url: string = (import.meta.env.VITE_BASE_URL as ImportMetaEnv)+'https://advapi.chandalen.dev/api/';
    protected base_url: string = 'https://advapi.chandalen.dev/api/';
